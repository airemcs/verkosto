...
export default function Sidebar() {
  return (
  <>
  <button data-drawer-target="sidebar" data-drawer-toggle="sidebar" aria-controls="sidebar" type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
    ...
    <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50">
      ...
      <ul className="space-y-2 font-medium">
        ...
        <li>
          ...
          <svg className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512">
        ...
        <li>
          <Link to="/recent" className="flex items-center p-2 text-gray-900 rounded-lg group">
          <svg className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
      ...
      <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
        ...
        <li>
          <Link to="/topics" className="flex items-center p-2 text-gray-900 rounded-lg group">
        ...
        <li>
          <Link to="/communities" className="flex items-center p-2 text-gray-900 rounded-lg group">
          <svg className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 640 512">
          ...
          <span className="ms-3">Communities</span>
          </Link>
        </li>
      ...
      <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
        ...
        <li>
          <Link to="/users/65f180fdceecc2241d6bad00" className="flex items-center p-2 text-gray-900 rounded-lg group">
