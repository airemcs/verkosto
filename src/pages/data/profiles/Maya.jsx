...
export default function Maya() {
  return (
    ...
    <Sidebar />
    <Searchbar />
    <Profile name="Maya Higa" bio="Computer Science Student" org="Computer Studies Government" banner="sand"
    location="Makati City, Philippines" facebook="/mayah" linkedin="mayah" />
