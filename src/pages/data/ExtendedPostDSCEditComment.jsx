...
import CommentNestTemporary from '../../components/post/CommentNestTemporary.jsx'
import Sidebar from '../../components/Sidebar.jsx'
import Searchbar from '../../components/Searchbar.jsx'
import ExtendedPost from '../../components/post/ExtendedPost.jsx'

export default function ExtendedPostDSCEditComment() {
    return(
    <> 
    <div className="sm:ml-64">
      ...
      <Sidebar />
      <Searchbar />
      <ExtendedPost name="Airelle Maagma" position="President" title="Join Our Data Science Community!" 
    ...
    <section>
      ...
      <CommentNestTemporary name="Airelle Maagma" date="February 10, 2024" content="Hey Maya! It isn't YET, but we're getting the paperwork done!" isAccount="1" />
